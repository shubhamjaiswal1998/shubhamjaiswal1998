...
class ATM {
    ...
    public void start() {
        ...
        if (authenticate(userId, userPin)) {
            ...
            System.out.println("Authentication failed. now terminating sorry  ");
        }
    }
...
class Bank_Transaction {
    ...
    public Bank_Transaction(String transactionType, double amount) {
...
class Account {
    ...
    private List<Bank_Transaction> transactionHistory;
    ...
    public void deposit(double amount) {
        balance += amount;
        transactionHistory.add(new Bank_Transaction("Deposit", amount));
    }

    public void withdraw(double amount) {
        if (balance >= amount) {
            balance -= amount;
            transactionHistory.add(new Bank_Transaction("Withdrawal", -amount));
        } else {
    ...
    public void transfer(Account recipient, double amount) {
        if (balance >= amount) {
            ...
            transactionHistory.add(new Bank_Transaction("Transfer", -amount));
        } else {
            System.out.println("Insufficient funds!");
        }
    }
    ...
    public void showTransactionHistory() {
        ...
        for (Bank_Transaction transaction : transactionHistory) {
